...
const menuOpcion2_Opcion1_Opcion2 = addKeyword(EVENTS.WELCOME)
    ...
    .addAnswer('*Ciudad DIF*' +
        ...
        delay: 1000,
        media: 'https://drive.google.com/file/d/1HxyQx_3efw_S4m991iupz9O3LeHrGvTb/view?usp=sharing'
        }
    )
    .addAnswer('*CAIF*' +
        '\nTeléfono: *8717333199*' +
...
const respuestaCJEM = addKeyword(EVENTS.WELCOME)
    ...
    .addAnswer('Teléfono: *8712226300*' +
        ...
        '\nHorario: *09:00 - 16:00 Hrs*',{
        delay: 1000,
        media: 'https://github.com/Jonathan98mtk/chatBot-IMDLM/blob/master/logos/CAIF.png'
        }
    )
    .addAction(
        async (ctx, {gotoFlow, fallBack, flowDynamic}) => {
